...
class AuthCommandControllerTest {
    ...
    class LoginTest {
        ...
        void givenValidLoginRequest_whenLogin_thenReturns201() throws Exception {
            ...
            LoginResponse useCaseResponse = new LoginResponse(
                    userId, accessToken, refreshToken, expiresIn, tokenType);

            given(authApiMapper.toLoginCommand(any(LoginApiRequest.class)))
                    .willReturn(command);
    ...
    class RefreshTokenTest {
        ...
        void givenValidRefreshRequest_whenRefresh_thenReturns200() throws Exception {
            ...
            long refreshTokenExpiresIn = 86400L;
            String tokenType = "Bearer";

            RefreshTokenCommand command = new RefreshTokenCommand(inputRefreshToken);
            TokenResponse useCaseResponse = new TokenResponse(
                    newAccessToken, newRefreshToken, accessTokenExpiresIn, refreshTokenExpiresIn, tokenType);
            ...
            mockMvc.perform(post("/api/v1/auth/refresh")
                    ...
                    .andExpect(jsonPath("$.data.refreshTokenExpiresIn").value(refreshTokenExpiresIn))
                    .andExpect(jsonPath("$.data.tokenType").value(tokenType));
    ...
    class LogoutTest {
        ...
        void givenValidLogoutRequest_whenLogout_thenReturns200() throws Exception {
            ...
            given(authApiMapper.toLogoutCommand(any(LogoutApiRequest.class)))
                    .willReturn(command);
