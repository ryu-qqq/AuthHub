...
/**
 * UpdateOrganizationNameApiRequest - 조직 이름 수정 요청 DTO
 *
 * <p>조직 이름 수정 API의 요청 본문을 표현합니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "조직 이름 수정 요청")
public record UpdateOrganizationNameApiRequest(
        @Schema(
                        description = "조직 이름",
