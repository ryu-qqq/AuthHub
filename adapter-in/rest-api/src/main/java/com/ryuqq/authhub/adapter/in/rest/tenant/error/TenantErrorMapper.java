...
/**
 * Tenant Bounded Context ErrorMapper
 *
 * <p>TENANT- 접두사를 가진 Domain Exception을 HTTP Problem Details로 변환합니다.
 *
 * <p>지원하는 에러 코드:
 * <ul>
 *   <li>TENANT-001 (TENANT_NOT_FOUND) → 404 Not Found</li>
 *   <li>TENANT-005 (ACTIVE_ORGANIZATIONS_EXIST) → 409 Conflict</li>
...
public class TenantErrorMapper implements ErrorMapper {
    ...
    private static final String TYPE_BASE = "https://api.authhub.com/problems/tenant/";

    private final MessageSource messageSource;

    public TenantErrorMapper(MessageSource messageSource) {
    ...
    private HttpStatus mapHttpStatus(String code) {
        return switch (code) {
            // 404 - 리소스 없음
            case "TENANT-001" -> HttpStatus.NOT_FOUND;

            // 409 - 충돌
            case "TENANT-005" -> HttpStatus.CONFLICT;
