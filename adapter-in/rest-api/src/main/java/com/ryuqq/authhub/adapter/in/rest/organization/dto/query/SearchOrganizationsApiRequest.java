...
/**
 * SearchOrganizationsApiRequest - 조직 목록 조회 요청 DTO
 *
 * <p>조직 목록 조회 API의 쿼리 파라미터를 표현합니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "조직 목록 조회 조건")
public record SearchOrganizationsApiRequest(
        @Schema(description = "테넌트 ID", requiredMode = Schema.RequiredMode.REQUIRED)
                ...
                String tenantId,
        @Schema(description = "조직 이름 검색어", example = "조직") String name,
        @Schema(
