 ...
 * @since 1.0.0
 */
public record EndpointSyncRequest(String serviceName, List<EndpointInfo> endpoints) {

    /**
     * EndpointSyncRequest 생성
     *
    ...
    public static EndpointSyncRequest of(String serviceName, List<EndpointInfo> endpoints) {
        return new EndpointSyncRequest(serviceName, endpoints);
    }
}
