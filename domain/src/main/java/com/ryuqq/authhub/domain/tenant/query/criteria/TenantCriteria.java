...
/**
 * TenantCriteria - 테넌트 검색 조건 Criteria
 *
...
public record TenantCriteria(
     ...
     */
    public static TenantCriteria of(
            String name,
            SearchType nameSearchType,
            List<TenantStatus> statuses,
            DateRange dateRange,
            ...
            SortDirection sortDirection,
            PageRequest page) {
        return new TenantCriteria(
                name,
                nameSearchType != null ? nameSearchType : SearchType.defaultType(),
                statuses,
                dateRange,
                sortKey != null ? sortKey : TenantSortKey.defaultKey(),
     ...
     * @return TenantCriteria
     */
    public static TenantCriteria ofSimple(
            String name,
            List<TenantStatus> statuses,
            DateRange dateRange,
            int pageNumber,
