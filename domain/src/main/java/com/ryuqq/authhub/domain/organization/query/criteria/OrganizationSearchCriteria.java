...
/**
 * OrganizationSearchCriteria - 조직 검색 조건 Criteria
 *
 ...
 *
 * <ul>
 *   <li>{@code tenantIds}: 테넌트 ID 목록 (선택 - null 시 전체 조회)
 *   <li>{@code searchWord}: 검색어 (선택)
 *   <li>{@code searchField}: 검색 필드 - NAME (필수)
...
public record OrganizationSearchCriteria(
        ...
        String searchWord,
        OrganizationSearchField searchField,
     ...
     */
    public static OrganizationSearchCriteria of(
            List<TenantId> tenantIds,
            String searchWord,
            OrganizationSearchField searchField,
            List<OrganizationStatus> statuses,
        ...
        QueryContext<OrganizationSortKey> context =
                QueryContext.of(sortKey, sortDirection, pageRequest);
        return new OrganizationSearchCriteria(
                tenantIds, searchWord, searchField, statuses, dateRange, context);
    }
     ...
     * @return OrganizationSearchCriteria
     */
    public static OrganizationSearchCriteria ofSimple(
            List<TenantId> tenantIds,
            String searchWord,
            List<OrganizationStatus> statuses,
            DateRange dateRange,
        ...
        return new OrganizationSearchCriteria(
                tenantIds,
                searchWord,
                OrganizationSearchField.defaultField(),
                statuses,
                dateRange,
                context);
    }
     ...
     * @return 정렬 키
     */
    public OrganizationSortKey sortKey() {
