...
/**
 * User의 고유 식별자를 나타내는 Value Object.
 * UUID 기반으로 전역적으로 유일한 사용자 식별자를 제공합니다.
 *
...
public record UserId(UUID value) {
    ...
    /**
     * 새로운 UUID를 생성하여 UserId를 만듭니다.
     *
     * @return 새로 생성된 UserId 인스턴스
     * @author AuthHub Team
     * @since 1.0.0
     */
     ...
     * @since 1.0.0
     */
    public static UserId fromString(final String uuidString) {
