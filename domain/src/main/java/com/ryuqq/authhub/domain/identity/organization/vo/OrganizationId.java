...
/**
 * Organization의 고유 식별자를 나타내는 Value Object.
 * UUID 기반으로 전역적으로 유일한 조직 식별자를 제공합니다.
 *
...
public record OrganizationId(UUID value) {
    ...
    /**
     * 새로운 UUID를 생성하여 OrganizationId를 만듭니다.
     *
     * @return 새로 생성된 OrganizationId 인스턴스
     * @author AuthHub Team
     * @since 1.0.0
     */
    ...
    /**
     * 기존 UUID 문자열로부터 OrganizationId를 생성합니다.
     *
     ...
     * @since 1.0.0
     */
    public static OrganizationId fromString(final String uuidString) {
    ...
    /**
     * 기존 UUID 객체로부터 OrganizationId를 생성합니다.
     *
     ...
     * @since 1.0.0
     */
    public static OrganizationId from(final UUID uuid) {
        return new OrganizationId(uuid);
    }

    /**
     * OrganizationId를 문자열로 변환합니다.
     *
     * @return UUID 문자열 표현
     * @author AuthHub Team
     * @since 1.0.0
