...
/**
 * Token 도메인의 최상위 예외 클래스.
 *
 * <p>모든 Token 관련 도메인 예외는 이 클래스를 상속합니다.
 ...
 * @since 1.0.0
 */
public class TokenDomainException extends RuntimeException {
     ...
     * @since 1.0.0
     */
    public TokenDomainException(final String message) {
        super(message);
    }
     ...
     * @since 1.0.0
     */
    public TokenDomainException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
