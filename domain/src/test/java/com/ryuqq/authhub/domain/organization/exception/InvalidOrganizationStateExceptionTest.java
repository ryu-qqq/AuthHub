...
class InvalidOrganizationStateExceptionTest {
    ...
    void shouldCreateExceptionWithOrganizationIdAndReason() {
        ...
        // When
        InvalidOrganizationStateException exception = new InvalidOrganizationStateException(organizationId, reason);

        // Then
        assertThat(exception.getCode()).isEqualTo("ORGANIZATION-004");
