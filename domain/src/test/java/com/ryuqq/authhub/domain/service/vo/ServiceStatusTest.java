...
@Tag("unit")
@DisplayName("ServiceStatus 테스트")
class ServiceStatusTest {

    @Nested
    @DisplayName("ServiceStatus description 테스트")
    class DescriptionTests {
        ...
        void activeDescriptionShouldBeActive() {
            // then
            assertThat(ServiceStatus.ACTIVE.description()).isEqualTo("활성");
        }
        ...
        void inactiveDescriptionShouldBeInactive() {
            // then
            assertThat(ServiceStatus.INACTIVE.description()).isEqualTo("비활성");
        }
    }

    @Nested
    @DisplayName("ServiceStatus isActive 테스트")
    class IsActiveTests {
        ...
        void activeShouldReturnTrue() {
            // then
            assertThat(ServiceStatus.ACTIVE.isActive()).isTrue();
        }
        ...
        void inactiveShouldReturnFalse() {
            // then
            assertThat(ServiceStatus.INACTIVE.isActive()).isFalse();
        }
    }

    @Nested
    @DisplayName("ServiceStatus isInactive 테스트")
    class IsInactiveTests {
        ...
        void activeShouldReturnFalse() {
            // then
            assertThat(ServiceStatus.ACTIVE.isInactive()).isFalse();
        }
        ...
        void inactiveShouldReturnTrue() {
            // then
            assertThat(ServiceStatus.INACTIVE.isInactive()).isTrue();
        }
    }
}
