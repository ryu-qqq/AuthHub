...
class DuplicateUserRoleExceptionTest {
    ...
    @Nested
    @DisplayName("DuplicateUserRoleException 생성 테스트")
    class CreateTests {
        ...
        void shouldCreateWithUserIdAndRoleId() {
            ...
            assertThat(exception.getErrorCode()).isEqualTo(UserRoleErrorCode.DUPLICATE_USER_ROLE);
            assertThat(exception.code()).isEqualTo("USER_ROLE-002");
    ...
    @Nested
    @DisplayName("DuplicateUserRoleException 에러 코드 테스트")
    class ErrorCodeTests {

        @Test
        @DisplayName("에러 코드는 DUPLICATE_USER_ROLE이다")
        void errorCodeShouldBeDuplicateUserRole() {
            // given
            DuplicateUserRoleException exception =
                    new DuplicateUserRoleException("01941234-5678-7000-8000-123456789001", 1L);
