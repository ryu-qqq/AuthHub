...
/**
 * SystemPermissionNotDeletableException 단위 테스트
 *
 * @author development-team
 * @since 1.0.0
 */
@Tag("unit")
@DisplayName("SystemPermissionNotDeletableException 테스트")
class SystemPermissionNotDeletableExceptionTest {
    ...
    class ConstructorTest {
        ...
        void shouldCreateExceptionWithPermissionKey() {
            ...
            // when
            SystemPermissionNotDeletableException exception =
                    new SystemPermissionNotDeletableException(permissionKey);

            // then
            assertThat(exception).isNotNull();
            assertThat(exception.code()).isEqualTo("PERMISSION-004");
    ...
    class InheritanceTest {
        ...
        void shouldExtendDomainException() {
            // given
            SystemPermissionNotDeletableException exception =
                    new SystemPermissionNotDeletableException("system:admin");
        ...
        void shouldUseCorrectErrorCode() {
            ...
            assertThat(exception.code())
                    .isEqualTo(PermissionErrorCode.SYSTEM_PERMISSION_NOT_DELETABLE.getCode());
            assertThat(exception.getMessage())
                    .isEqualTo(PermissionErrorCode.SYSTEM_PERMISSION_NOT_DELETABLE.getMessage());
        }
    }
}
