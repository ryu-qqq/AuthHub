...
class RolePermissionNotFoundExceptionTest {
    ...
    class ConstructorTest {
        ...
        void shouldCreateExceptionWithRoleIdAndPermissionId() {
            ...
            assertThat(exception.code()).isEqualTo("ROLE-006");
    ...
    class InheritanceTest {
        ...
        void shouldExtendDomainException() {
            // given
            RolePermissionNotFoundException exception =
                    new RolePermissionNotFoundException(UUID.randomUUID(), UUID.randomUUID());
        ...
        void shouldUseCorrectErrorCode() {
            ...
            assertThat(exception.code())
                    .isEqualTo(RoleErrorCode.ROLE_PERMISSION_NOT_FOUND.getCode());
            assertThat(exception.getMessage())
                    .isEqualTo(RoleErrorCode.ROLE_PERMISSION_NOT_FOUND.getMessage());
        }
    }
}
