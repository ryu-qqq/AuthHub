# ========================================
# ECS Cluster for AuthHub - STAGE
# ========================================
# Dedicated ECS Cluster (not shared)
# Naming: authhub-cluster-stage
# ========================================
...
resource "aws_ecs_cluster_capacity_providers" "main" {
  ...
  # Stage: FARGATE_SPOT 우선 사용으로 비용 절감
...
resource "aws_ssm_parameter" "cluster_arn" {
  ...
  description = "AuthHub ECS cluster ARN (${var.environment})"
  type        = "String"
...
resource "aws_ssm_parameter" "cluster_name" {
  ...
  description = "AuthHub ECS cluster name (${var.environment})"
  type        = "String"
