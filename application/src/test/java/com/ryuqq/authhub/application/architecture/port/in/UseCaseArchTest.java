package com.ryuqq.authhub.application.architecture.port.in;
...
class UseCaseArchTest {
    ...
    private static final String COMMAND_USE_CASE_PATTERN =
            "(Create|Update|Delete|Place|Cancel|Confirm|Register|Remove|"
                    + "Modify|Approve|Reject|Send|Process|Execute).*UseCase";
                    ...
                    classes.stream()
                            ...
                            .filter(
                                    javaClass ->
                                            !javaClass
                                                    .getSimpleName()
                                                    .matches(COMMAND_USE_CASE_PATTERN))
                            .count();
