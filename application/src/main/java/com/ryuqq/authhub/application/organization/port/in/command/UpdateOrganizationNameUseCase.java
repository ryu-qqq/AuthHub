...
/**
 * UpdateOrganizationNameUseCase - 조직 이름 변경 UseCase (Port-In)
 *
 * <p>조직 이름 변경 기능을 정의합니다.
 *
 ...
 * @since 1.0.0
 */
public interface UpdateOrganizationNameUseCase {

    /**
     * 조직 이름 변경 실행
     *
     * @param command 조직 이름 변경 Command
     */
    void execute(UpdateOrganizationNameCommand command);
}
