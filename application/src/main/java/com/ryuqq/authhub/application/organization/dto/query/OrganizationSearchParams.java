...
/**
 * OrganizationSearchParams - 조직 목록 조회 SearchParams DTO
 *
 * <p>조직 목록을 페이지 기반으로 조회하는 SearchParams DTO입니다.
 *
 ...
 * @param tenantIds 테넌트 ID 목록 (null 시 전체 조회)
 * @param searchWord 검색어 (null 허용)
 * @param searchField 검색 필드 - NAME (null 허용, 기본: NAME)
 * @param statuses 조직 상태 필터 목록 (null 또는 빈 목록 시 전체)
...
public record OrganizationSearchParams(
    ...
    /**
     * OrganizationSearchParams 생성 (전체 파라미터)
     *
     * @param searchParams 공통 검색 파라미터
     * @param tenantIds 테넌트 ID 목록
     * @param searchWord 검색어
     * @param searchField 검색 필드
     * @param statuses 조직 상태 필터 목록
     * @return OrganizationSearchParams 인스턴스
     */
    public static OrganizationSearchParams of(
            CommonSearchParams searchParams,
            List<String> tenantIds,
            String searchWord,
            String searchField,
        ...
        return new OrganizationSearchParams(
                searchParams, tenantIds, searchWord, searchField, statuses);
    }

    /**
     * OrganizationSearchParams 생성 (간편 생성)
     *
     * @param tenantIds 테넌트 ID 목록
     * @param searchWord 검색어
     * @param searchField 검색 필드
     ...
     * 테넌트 필터가 있는지 확인
     *
     * @return tenantIds가 null이 아니고 비어있지 않으면 true
     */
