...
public class SearchOrganizationsAdminService implements SearchOrganizationsAdminUseCase {
     ...
     */
    public SearchOrganizationsAdminService(OrganizationAdminQueryPort adminQueryPort) {
     ...
     * Admin 조직 목록 검색 실행
     *
     * <p>AdminQueryPort를 통해 tenantName, userCount를 포함한 Summary DTO를 직접 조회합니다.
     *
    ...
    public PageResponse<OrganizationSummaryResponse> execute(SearchOrganizationsQuery query) {
        return adminQueryPort.searchOrganizations(query);
    }
}
